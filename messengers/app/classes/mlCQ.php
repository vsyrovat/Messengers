...
/*
 * http://destym.livejournal.com/26561.html
 *
...
class mlCQ {
    ...
    var $debug = 100;            // debug level: 0 - no debug (outputs fatal errors only), 1 - errors + basic messages
    ...
    function create_identity($name, $uin, $pass) {
        $this->identities[$name] = array(
            ...
            'out_seqnum'     => 1337/*rand(1, 20000)*/,    // not anymore randomly generated out sequence number, but it used to be
    ...
    function send_message($uin, $text) {
        ...
        $this->debug_msg('Message for ' . $uin . ' has been sent.');
